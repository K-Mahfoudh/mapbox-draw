...
// Displaying data withing a polygon
            ...
            success: function(e) { 
                ...
                if (search_db_name == 'airports'){
                    ...
                    for(element in feature_list) {
                        let distance = turf.distance(feature_list[element], targetPoint);
                        distance_dict[distance] = feature_list[element];
                    }
                    ...
                    let neighbour_list = []
                    for(let i =0; i<n; i++) {
                        console.log(sorted_key_list[i]);
                        neighbour_list.push(distance_dict[sorted_key_list[i]])
                    }
